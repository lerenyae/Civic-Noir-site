...
const tracks = [
  ...
  { num: "02", title: "Fathers Don't Fade", time: "3:01", character: "Shawn / Leo", spotifyId: "74rRuKf03NRA8f8CTHe92s", moment: "Leo's collapse on the courthouse steps. The briefcase. The inheritance no one asked for." },
  ...
  { num: "07", title: "Cold Trail", time: "3:11", character: "Jordan", spotifyId: "6CXm0SlH8eVWxVg0ggeO0o", moment: "Jordan chasing the missing witness. Eve behind Red Orchid. The story that doesn't want exposure." },
  ...
  { num: "12", title: "Glass Halo", time: "4:14", character: "Antonio", spotifyId: "4Bd28ZsdnWHylAcrstX5iM", moment: "TRUTH IS A BID carved in the wall. The metal sheet pretending to be a mirror. A boy learning to breathe where no one taught him how." },
