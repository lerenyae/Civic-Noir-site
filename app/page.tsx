    ...
    <>
      <section className="relative min-h-[90vh] flex items-center justify-center px-6">
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          <p className="font-serif text-lg md:text-xl text-bone-300/50 font-light italic max-w-lg mx-auto mb-12 animate-fade-in delay-500">Systems over heroes. Subtext over speeches.<br /></p>
