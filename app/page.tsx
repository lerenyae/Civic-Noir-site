  ...
  return (
    <>
      ...
      <section className="py-20 px-6 border-t border-bone-300/5">
        <SectionReveal>
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-[10px] font-sans font-light tracking-ultra uppercase text-gold/75 mt-6">From Contempt</p>
          </div>
        </SectionReveal>
      </section>
        ...
        <SectionReveal>
          <div className="max-w-2xl mx-auto text-center">
            <div className="flex items-center justify-center gap-4 mb-10">
              ...
              <p className="text-[10px] font-sans font-light tracking-ultra uppercase text-gold/75">Official Trailer</p>
              <div className="h-px flex-1 max-w-[60px] bg-gold/20" />
            </div>
      ...
      <section className="py-24 px-6">
        <SectionReveal>
          <div className="max-w-4xl mx-auto text-center">
            <div className="flex items-center justify-center gap-4 mb-10">
              <div className="h-px flex-1 max-w-[60px] bg-gold/20" />
              <p className="text-[10px] font-sans font-light tracking-ultra uppercase text-gold/75">Cold Read</p>
              <div className="h-px flex-1 max-w-[60px] bg-gold/20" />
            </div>
            <p className="font-serif text-base text-bone-300/60 font-light italic mb-14">Excerpts from Contempt</p>
            <ColdReadCarousel />
            <div className="mt-12">
              <Link href="/chapter-one" className="text-[10px] font-sans font-light tracking-ultra uppercase text-gold/70 hover:text-gold/70 transition-colors duration-300">Read Chapter One &rarr;</Link>
            </div>
          </div>
        </SectionReveal>
      </section>
      ...
      <section className="py-24 px-6 border-t border-bone-300/5">
        <SectionReveal>
          <div className="max-w-2xl mx-auto text-center">
            <p className="text-[10px] font-sans font-light tracking-ultra uppercase text-gold/75 mb-6">The Score</p>
            <h2 className="font-serif text-3xl md:text-4xl text-bone-200 font-light mb-5">A novel with its own soundtrack.</h2>
            <p className="text-sm text-bone-300/75 font-light leading-relaxed max-w-md mx-auto mb-10">
            ...
            <Link href="/soundtrack" className="text-[10px] font-sans font-light tracking-ultra uppercase text-gold/70 hover:text-gold/70 transition-colors duration-300">Hear the full score &rarr;</Link>
          </div>
        </SectionReveal>
      </section>
      ...
      <section className="py-32 px-6">
        <div className="max-w-5xl mx-auto">
          <SectionReveal><p className="text-[10px] font-sans font-light tracking-ultra uppercase text-gold/75 mb-12">Available Now</p></SectionReveal>
          <div className="grid grid-cols-1 md:grid-cols-[1fr_1.5fr] gap-16 items-start">
            ...
            <SectionReveal delay={200}>
              <div>
                ...
                <p className="text-xs text-bone-300/70 font-sans font-light tracking-widest uppercase mb-8">{contempt.genre}</p>
                ...
                <p className="text-sm text-bone-300/75 font-light leading-[1.8] mb-8">{contempt.synopsis.split("\n\n")[0]}</p>
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center px-6 py-24">
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          <Link href="/civic-noir" className="text-[10px] font-sans font-light tracking-ultra uppercase text-gold/75 mb-8 animate-fade-in hover:text-gold/80 transition-colors duration-300 block">{siteConfig.tagline}</Link>
      ...
      <section className="py-24 px-6 border-t border-b border-bone-300/5">
        <SectionReveal>
          <Link href="/civic-noir" className="block max-w-2xl mx-auto text-center group">
            <p className="text-[10px] font-sans font-light tracking-ultra uppercase text-gold/75 mb-8 group-hover:text-gold/80 transition-colors duration-300">What is Civic Noir</p>
            ...
            <p className="text-[10px] font-sans font-light tracking-ultra uppercase text-gold/60 mt-6 group-hover:text-gold/60 transition-colors duration-300">Read the full definition &rarr;</p>
          </Link>
        </SectionReveal>
      </section>
      ...
      <section className="py-24 px-6">
        <SectionReveal>
          <div className="max-w-2xl mx-auto text-center">
            <p className="text-[10px] font-sans font-light tracking-ultra uppercase text-gold/75 mb-8">Acknowledgements</p>
            <h2 className="font-serif text-3xl md:text-4xl text-bone-200 font-light mb-6">This book exists because of you.</h2>
            <p className="text-sm text-bone-300/75 font-light leading-relaxed max-w-lg mx-auto mb-12">
            ...
            <p className="text-[10px] font-sans font-light tracking-ultra uppercase text-gold/70 mb-4">The Circle</p>
            <p className="text-sm text-bone-300/75 font-light leading-relaxed mb-12">
            ...
            <div className="w-12 h-px bg-gold/30 mx-auto mb-12" />
            <p className="text-[10px] font-sans font-light tracking-ultra uppercase text-gold/70 mb-4">The Readers</p>
            <p className="text-sm text-bone-300/75 font-light leading-relaxed">
