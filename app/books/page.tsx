...
export default function BooksPage() {
  ...
  return (
    <>
      ...
      <section className="pt-16 pb-8 px-6"><div className="max-w-5xl mx-auto"><SectionReveal><p className="text-[10px] font-sans font-light tracking-ultra uppercase text-gold/75 mb-4">{contempt.status}</p></SectionReveal>
      ...
      <section className="py-20 px-6">
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.8fr] gap-16 items-start">
            ...
            <div>
              <SectionReveal><div className="mb-10"><p className="text-[10px] font-sans font-light tracking-ultra uppercase text-gold/75 mb-4">About the Book</p>
      ...
      <section className="py-20 px-6 border-t border-bone-300/5">
        <div className="max-w-3xl mx-auto">
          <SectionReveal><p className="text-[10px] font-sans font-light tracking-ultra uppercase text-gold/75 mb-8 text-center">Behind the Book</p>
          ...
          <SectionReveal delay={100}><div>{contempt.inspiration.split("\n\n").map((para, i) => (<p key={i} className={`text-sm text-bone-300/75 font-light leading-[1.8] ${i < contempt.inspiration.split("\n\n").length - 1 ? "mb-6" : ""}`}>{para}</p>))}</div></SectionReveal>
        </div>
      </section>
      )}
      ...
      <section className="py-16 px-6">
        <div className="max-w-3xl mx-auto text-center">
          <SectionReveal><p className="text-[10px] font-sans font-light tracking-ultra uppercase text-gold/75 mb-8">Themes</p>
          <div className="flex flex-wrap justify-center gap-4">{contempt.themes.map((theme, i) => (<span key={i} className="text-xs font-sans font-light tracking-widest uppercase text-bone-300/70 border border-bone-300/10 px-4 py-2">{theme}</span>))}</div></SectionReveal>
        </div>
      </section>
      )}
      ...
      <section className="py-16 px-6 border-t border-bone-300/5">
        <div className="max-w-3xl mx-auto text-center">
          <SectionReveal><p className="text-[10px] font-sans font-light tracking-ultra uppercase text-gold/75 mb-8">Get the Book</p>
