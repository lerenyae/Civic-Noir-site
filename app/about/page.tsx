      ...
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-[1fr_1.6fr] gap-16 items-start">
            <SectionReveal><div className="relative aspect-[3/4] overflow-hidden border border-bone-300/5 sticky top-28"><Image src="/covers/IMG_2374.JPG?v=tux" alt={siteConfig.name} fill className="object-cover" /></div></SectionReveal>
            <div>
