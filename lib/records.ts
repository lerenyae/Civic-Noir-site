...
export const records: RecordEntry[] = [
  ...
  },
  {
    ...
    date: "1999-03-06",
    displayDate: "March 6, 1999",
    institution: "Davidson & Associates LLC — Internal",
    excerpt:
      "Shawn was twenty-five. His signature sits beside his father's at the bottom of the deal memo — the first time a Davidson appeared twice on the same closing. Four point two million dollars. Three parcels in the Harbor East TIF District. Seven years later, Jordan Grey would follow this transaction through seventeen shell transfers and arrive at a question no one at the firm wanted asked. The Macallan 25 on the table is Leo's. It always was.",
