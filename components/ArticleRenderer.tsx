...
const articleContent: Record<string, { body: string[]; byline?: string; deck?: string }> = {
  "garrick-shooting-sentinel": {
    ...
    body: [
      ...
      "The Baltimore Sentinel will continue to follow developments in this story.",
    ],
  },
  "sentinel-editorial-grey-byline": {
    ...
    body: [
      ...
      "The Sentinel requested comment from Mayor Dawson's office, the Department of Finance, and the Department of Housing and Community Development. None provided a substantive response by press time.",
...
export function ArticleRenderer({ record }: { record: RecordEntry }) {
  ...
  const displayDate = record.date.toUpperCase();
  ...
  return (
    ...
    >
      <link
        href="https://fonts.googleapis.com/css2?family=UnifrakturMaguntia&family=Playfair+Display:ital,wght@0,400;0,700;0,900;1,400;1,700&family=IBM+Plex+Mono:wght@300;400&family=Outfit:wght@200;300&display=swap"
        rel="stylesheet"
      />
      ...
      >
        ...
        <div style={{ padding: "32px 40px 40px" }}>
          ...
          <p style={{ fontSize: 9, color: "#777", letterSpacing: "0.15em", textTransform: "uppercase", textAlign: "center" }}>
            © {record.date.split(",").pop()?.trim() || "2005"} The Baltimore Sentinel — All Rights Reserved
          </p>
        </div>
      </div>
