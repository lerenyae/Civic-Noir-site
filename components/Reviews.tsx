      ...
      <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16">
        {reviews.map((r, i) => (
          <figure key={i} className="text-center">
            ...
            <figcaption className="text-[10px] font-sans font-light tracking-ultra uppercase text-bone-300/70">
              {r.author} &mdash; <span className="text-gold/70">{r.source}</span>
            </figcaption>
            {r.url && (
            <a
              href={r.url}
              ...
              className="inline-block mt-3 text-[10px] font-sans font-light tracking-ultra uppercase text-gold/75 hover:text-gold/90 transition-colors duration-300"
            >
