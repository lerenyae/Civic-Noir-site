...
const memoContent: Record<string, {
  ...
  "chesapeake-civic-wire-memo": {
    ...
    body: [
      ...
      { text: " " },
      { text: "Bond closes Monday or the harbor suffocates.", redacted: true },
      { text: "\n\n[Document withheld pending trial proceedings. Full text to be restored post-publication.]" },
