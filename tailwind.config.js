...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      letterSpacing: { widest: "0.2em", ultra: "0.35em" },
      animation: { "fade-in": "fadeIn 0.8s ease-out forwards", "fade-up": "fadeUp 0.8s ease-out forwards", "line-grow": "lineGrow 1.2s ease-out forwards" },
      keyframes: {
